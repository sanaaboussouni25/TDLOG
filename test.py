...
class TestModeGames(unittest.TestCase):
    def test_least_asked_questions(self):
        self.assertEqual(least_asked_questions("Vocabulaire nourriture"), ['Oeuf', 'Gâteau', 'Bonbon'])

    def test_most_missed_questions(self):
        self.assertEqual(missed_questions("Vocabulaire nourriture"), ['Frites', 'Jambon', 'Tomate'])

    def test_is_answer_right(self):
        self.assertTrue(is_answer_right("Frites", "Fries"))
        self.assertFalse(is_answer_right("Jambon", "Beurre")[0])

    def test_lesson_name(self):
        self.assertTrue(lesson_name(1, "Anglais"), "Vocabulaire nourriture")
